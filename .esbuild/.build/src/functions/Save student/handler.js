...
// src/functions/Save student/handler.ts
__export(exports, {
  main: () => main
});
...
var save_student = async (event) => {
  try {
    ...
    const student = await DynamoDB2.scanWholeData(query);
    ...
    if (flag) {
      ...
      await DynamoDB2.SaveData(query2);
      return formatJSONResponse({
