...
// src/functions/Get one enrollement/handler.ts
__export(exports, {
  main: () => main
});
...
// src/functions/Get one enrollement/handler.ts
var get_one_enrollement = async (event) => {
  try {
    ...
    const enrolled = await DynamoDB2.getData(query);
...
var main = middyfy(get_one_enrollement);
