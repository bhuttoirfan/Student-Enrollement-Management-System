...
// src/functions/Save enrollement/handler.ts
__export(exports, {
  main: () => main
});
...
// src/functions/Save enrollement/handler.ts
var add_enrollement = async (event) => {
  try {
    ...
    const course = await DynamoDB2.scanWholeData(check_course);
    ...
    if (flag) {
      ...
      await DynamoDB2.SaveData(query);
      return formatJSONResponse({
...
var main = middyfy(add_enrollement);
